"""
Django settings for axf_test project.
...
SECRET_KEY = '!e7k*gfx50r2n#u6$6%+b-iayv$h*1a_#@=uoi41qu!=s5i%r#'
...
WSGI_APPLICATION = 'axf_test.wsgi.application'
